...
declare variable $PATH as xs:string := "/home/DataChemist/data/ops/split/";
...
let $files := file:descendants("/home/DataChemist/data/bibframexml")

return xquery:fork-join(

for tumbling window $w in $files
end at $e when $e mod 10 eq 0
...
return 
file:write-text($PATH || "data_for_embedding_v5_" || random:uuid() ||  ".csv",
csv:serialize(<csv>{
